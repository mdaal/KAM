...
if 1: #power sweeps
	Run52b1st	= KAM.sweep(); Run52b1st.load_hf5('/Run52b/T201503041056',filename = database_location); Run52b1st.metadata.width = 256; Run52b1st.metadata.custom = [True, '; hex gnd', '--']
	Run52b2nd	= KAM.sweep(); Run52b2nd.load_hf5('/Run52b/T201503112352',filename = database_location); Run52b2nd.metadata.width = 256; Run52b2nd.metadata.custom = [False,'; hex gnd; $f_1$', ':']
	Run51aP	    = KAM.sweep(); Run51aP.load_hf5('/Run51a/T201411162028',filename = database_location); Run51aP.metadata.width = 32;	Run51aP.metadata.custom = [True,'', '-']
	Run51bP     = KAM.sweep(); Run51bP.load_hf5('/Run51b/T201411180125',filename = database_location); Run51bP.metadata.width = 16; Run51bP.metadata.custom = [True,'', '-']
	Run49aP     = KAM.sweep(); Run49aP.load_hf5('/Run49a/T201404232144', filename = database_location); Run49aP.metadata.width = 4; Run49aP.metadata.custom = [True,'', '-']
	Run48bP     = KAM.sweep(); Run48bP.load_hf5('/Run48b/T201404011305', filename = database_location); Run48bP.metadata.width = 32; Run48bP.metadata.custom = [True,'', '-']
	Run48aP     = KAM.sweep(); Run48aP.load_hf5('/Run48a/T201403311119', filename = database_location); Run48aP.metadata.width = 8; Run48aP.metadata.custom = [True,'', '-']
	Run46aPl    = KAM.sweep(); Run46aPl.load_hf5('/Run46a/T201402211440', filename = database_location); Run46aPl.metadata.width = 256; Run46aPl.metadata.custom = [True,'', '-']
	Run46aPh    = KAM.sweep(); Run46aPh.load_hf5('/Run46a/T201402211413', filename = database_location); Run46aPh.metadata.width = 256; Run46aPh.metadata.custom = [True,'', '-']# high power
	Run45bP     = KAM.sweep(); Run45bP.load_hf5('/Run45b/T201402062055', filename = database_location); Run45bP.metadata.width = 128; Run45bP.metadata.custom = [True,';70nm gnd; loose torq', '-']# to high power
	Run45aP     = KAM.sweep(); Run45aP.load_hf5('/Run45a/T201402061732', filename = database_location); Run45aP.metadata.width =64; Run45aP.metadata.custom = [True,'', '-']# to high power
	Run44bP     = KAM.sweep(); Run44bP.load_hf5('/Run44b/T201312102229', filename = database_location); Run44bP.metadata.width = 32; Run44bP.metadata.custom = [True,'; Cu box', '-']
	Run44aP     = KAM.sweep(); Run44aP.load_hf5('/Run44a/T201312101928', filename = database_location); Run44aP.metadata.width = 128; Run44aP.metadata.custom = [True,';70nm gnd', '-']
...
if 1: #temperature sweeps
	...
	Run51bTP = KAM.sweep(); Run51bTP.load_hf5('/Run51b/T201411231148',filename = database_location); Run51bTP.metadata.width = 16
